...
/*
  NOTE: Самописная утилита для обработки окончаний слов великого и могучего.
  Используется в основном проекте: https://github.com/MiracleHorizon/react-food/tree/main/client/src/utils/RuNounNumeralFormatter
*/
