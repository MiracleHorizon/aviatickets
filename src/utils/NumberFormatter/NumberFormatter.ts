...
/*
  NOTE: Самописная утилита для обработки числовых значений.
  Используется в основном проекте: https://github.com/MiracleHorizon/react-food/tree/main/client/src/utils/NumberFormatter
*/
